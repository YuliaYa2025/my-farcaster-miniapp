...
export async function POST(request: Request) {
  ...
  switch (event.event) {
    case "frame_added":
      ...
      if (event.notificationDetails) {
        ...
        await sendFrameNotification({
          fid,
          title: `Welcome to BA Survival Kit`,
          body: `Thank you for adding BA Survival Kit to your account!`,
        });
      } else {
    ...
    case "notifications_enabled": {
      ...
      await sendFrameNotification({
        fid,
        title: `BA Survival Kit Notifications`,
        body: `Thanks for enabling notifications! Stay tuned for Devconnect updates.`,
      });
